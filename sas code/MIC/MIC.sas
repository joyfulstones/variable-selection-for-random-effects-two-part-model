...
%mend();
%macro estimate();
libname two 'E:\two-part\code\sas code\MIC';
%do jj=1%to 1;
%do kk=0%to 4;
proc import out=two.two_part2&jj 
datafile="E:\two-part\code\sas code\MIC\data\two_part2&jj..csv" 
dbms=csv
replace;
run;
%nlm&kk(two.two_part2&jj) 
data two.one;
set _null_;
run;
data two.one;
...
%macro toge();
%do kk=0%to 4;
data two.estL&kk.all;  
set _null_;
run;
data two.hesL&kk.all;  
set _null_;
run;
data two.liL&kk.all;  
set _null_;
...
run;
data two.estL&kk.all;   
set two.estL&kk.all two.onet&ii.L&kk;   
run;
data two.hesL&kk.all;  
set two.hesL&kk.all two.cov&ii.L&kk;  
run;
data two.liL&kk.all;  
set two.liL&kk.all two.likelihood&ii.L&kk;  
run;
%end;
%end;
%mend();
...
%macro estimate1();
%do kk=0%to 4;
proc export data=two.estL&kk.all
outfile="E:\two-part\code\sas code\MIC\Results_save1\estL&kk.all.csv"
dbms=csv
label
replace;
run;

proc export data=two.hesL&kk.all
outfile="E:\two-part\code\sas code\MIC\Results_save1\hesL&kk.all.csv"
dbms=csv
label
replace;
run;

proc export data=two.liL&kk.all
outfile="E:\two-part\code\sas code\MIC\Results_save1\liL&kk.all.csv"
dbms=csv
label
replace;
run;
